...
def preprocess():
    ...
    parser.add_argument('--train_path', default='baike2018qa/baike_qa_train.json', type=str, required=False, help='训练日志存放位置')
    parser.add_argument('--save_path', default='baike2018qa/baike_qa_train_small_52w_13317.pkl', type=str, required=False, help='tokenize的训练数据集')
    ...
    train_data = []
    for line in open('baike2018qa/baike_qa_train.json','r'):
