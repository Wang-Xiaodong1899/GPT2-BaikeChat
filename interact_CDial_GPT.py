...
def run():
    ...
    parser.add_argument("--model_checkpoint", type=str, default="model/min_ppl_model_CDial_ilr_1e-05_tbs128_9_T10", help="Path, url or short name of the model")
